...
<head>
    ...
    <title>Teave töötajate kohta</title>
...
<div class="container">
    <div class="lang_info">
        ...
        <a href="login.php" class="admin_btn">Sisselogimine</a>
        <a href="et.php" class="tagasi_btn">Tagasi</a>
    </div>
    <button class="menu">
        <img src="images/menu.png" class="menu-icon">
    </button>
    <div class="sidebar">
        <a href="login.php">Sisselogimine</a>
        <a href="et.php">Tagasi</a>
    ...
    <h1 class="header_txt">Töötajate teave</h1>
    <form method="get" action="" class="form1">
        <label for="category" class="lbl_form">Valige kategooria:</label>
        <select name="category" id="category" class="form_select">
            <option value="0">Kõik kategooriad</option>
            <option value="1">Betoonitööd</option>
            <option value="2">Elektrikud</option>
            <option value="3">Tööline</option>
            <option value="4">Tugevdajad</option>
            <option value="5">Puusepad</option>
            <option value="6">Assembler</option>
            <option value="7">Keevitajad</option>
            <option value="8">Ekskavaatori operaator</option>
        </select>
        <input type="submit" value="Otsi" class="form_sumbit">
    </form>
    <!--<?php
    while ($kask->fetch()) {
        $totalUsers++;
    ...
    <h3 class="lbl_info">
        <?php
        if ($totalUsers <= 0) {
            echo "Vaba tööjõudu ei ole";
        } else {
            echo "Olemasolevate töötajate koguarv: " . $totalUsers;
        }
        ?>
    </h3>
    <button class="btn_contact" onclick="window.location.href='contact.php'">Kirjuta kiri</button>
</div>
</body>
<footer>
